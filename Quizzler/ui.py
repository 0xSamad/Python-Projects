...
class QuizInterface:
    def __init__(self,quiz_brain:QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150,125,width=270,text="Some question text",fill="black",font=("arial",15,"normal"))

        self.true_img = PhotoImage(file=true_image)
        self.false_img = PhotoImage(file=false_image)
